...
if (!empty($_POST)) {
    $alert = "";
    if (empty($_POST['nombre']) || empty($_POST['titulo']) || empty($_POST['correo']) || empty($_POST['telefono']) || empty($_POST['usuario'])) {
        ...
        $sql_update = mysqli_query($conexion, "UPDATE usuario SET nombre = '$nombre', titulo = '$titulo', correo = '$correo', telefono = '$telefono', usuario = '$usuario' WHERE idusuario = $idusuario");
            ...
            <div class="card-body">
                <form class="" action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Ingrese titulo" class="form-control" name="titulo" id="titulo" value="<?php echo $titulo; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" placeholder="Ingrese telefono" class="form-control" name="telefono" id="telefono" value="<?php echo $telefono; ?>">
