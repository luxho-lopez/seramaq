...
if (!empty($_POST)) {
    $alert = "";
    if (empty($_POST['nombre']) || empty($_POST['titulo']) || empty($_POST['correo']) || empty($_POST['telefono']) || empty($_POST['usuario']) || empty($_POST['clave'])) {
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO usuario(nombre,titulo,correo,telefono,usuario,clave) values ('$nombre', '$titulo', '$email', '$telefono', '$user', '$clave')");
            if ($query_insert) {
            ...
            <div class="modal-body">
                <form action="" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Ingrese Titulo: ING. LIC. " name="titulo" id="titulo">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" placeholder="Ingrese Telefono" name="telefono" id="telefono">
                    </div>
                    <div class="form-group">
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td><?php echo $data['titulo']; ?> <?php echo $data['nombre']; ?></td>
