...
$pdf->Image("../../assets/img/logo2.png", 150, 10, 60, 30, 'PNG');
$pdf->Ln();
...
$pdf->Cell(196, 5, "Datos del proyecto", 1, 1, 'C', 1);
$pdf->SetTextColor(0, 0, 0);
$pdf->Cell(90, 5, utf8_decode('Nombre del Proyecto'), 0, 0, 'L');
$pdf->Ln();
$pdf->SetFont('Arial', '', 10);
...
$pdf->SetFont('Arial', 'B', 10);
$pdf->SetTextColor(0, 0, 0);
$pdf->Cell(50, 5, utf8_decode('Numero Contrato'), 0, 0, 'L');
$pdf->Ln();
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(50, 5, utf8_decode($datosC['contrato']), 0, 0, 'L');

$pdf->Ln(5);
$pdf->SetFont('Arial', 'B', 10);
$pdf->SetTextColor(0, 0, 0);
$pdf->Cell(56, 5, utf8_decode('Planta'), 0, 1, 'L');
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(56, 5, utf8_decode($datosC['planta']), 0, 1, 'L');
